...
class MainWindow(QtWidgets.QMainWindow, Ui_MainWindow):
    ...
    def habilitarDeshabilitarBlancas(self):
        ...
        if self.miTurno == False:
            ...
            self.deshabilitarBotones()
            self.miTurno = False
            valoresMinMax = self.minMax(self.convertirTablero(arrayTablero), 5, "Negras", -sys.maxsize - 1,
                                        sys.maxsize)
    ...
    def moverFichaNegras(self, posX, posY, newX, newY, comer):
        self.quitarColor()
        arrayTablero[posX][posY].setText("")
        arrayTablero[posX][posY].setStyleSheet("background-color:#b1cbbb")
        arrayTablero[newX][newY].setStyleSheet("background-color:#b1cbbb")
    ...
    def siguienteMovimiento(self, x, y):
        ...
        arrayTablero[x][y].setStyleSheet("background-color:#b1cbbb")
